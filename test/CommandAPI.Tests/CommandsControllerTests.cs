...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        [Fact]
        public void GetAllCommands_ReturnOneItem_WhenDBHasOneResourse()
        {
            //Given
            //Arrange
        ...
        [Fact]
        public void GetAllCommands_ReturnsCorrectType_WhenDBHasOneResourse()
        {
            //Given
            //Arrage
            mockRepo.Setup(repo =>
        ...
        private IEnumerable<Command> GetCommands(int num)
        {
            ...
            if (num > 0)
            {
                ...
                {
                    Id = 0,
                    HowTo = "How to generate a migrations",
